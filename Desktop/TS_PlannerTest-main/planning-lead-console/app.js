            ...
            const initialiseFeedback = () => {
              ...
              script.onload = async function () {
                new window.TiramaiFeedbackLib({
                  // Required
                  apiKey: "eyJidXNpbmVzc0lkZWFJZCI6ImRlYmMxNGY2LTJmMDItNDc4YS1hMjU1LTcxY2UyY2E5OWFjMCIsImNyZWF0ZWRBdCI6MTc2Mzk5Mjk5ODE1OSwiY3JlYXRlZEJ5IjoiY29kZWdlbmVzaXMifQ==",

                  // Context
                  businessIdeaId: "debc14f6-2f02-478a-a255-71ce2ca99ac0",
                  projectName: "Planning Lead Console",
                  personaRole: "Planning Lead",
                  email: "N/A",
...
const initialiseRefiner = () => {
  ...
  script.onload = function () {
    ...
    new window.RefinerLib({
      ...
      personaRole: "Planning Lead",
      appTitle: "Planning Lead Console",
      appType: "business",
      businessIdeaId: "debc14f6-2f02-478a-a255-71ce2ca99ac0",
      environment: "development",
    });
